import { handler } from '../../src/services/starships/decrementStarshipAmountLambda';
import { APIGatewayProxyEvent } from 'aws-lambda';
import { DynamoDocumentClient } from '../../src/services/dataLayer/DynamoDocumentClient';

describe('DecrementStarshipAmountLambda Tests', () => {
  ...
  it('Should return 400 if amount is already 0', async () => {
    ...
    expect(JSON.parse(result.body)).toEqual({ success: false, message: 'Amount for Starship with id: 123 is already 0' });
  });
